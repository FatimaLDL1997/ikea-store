...
import Wrapper from "../../assets/wrappers/AllNewProducts";
...
const AllNewProducts = () => {
  ...
  const clickChange = (e) => {
    ...
    const containers = Array.from (e.currentTarget.parentElement.parentElement.children)
    ...
    console.log(containerClicked.children[0])
  ...
  const radioClicked = (e)=>{
    const allRadioBtnsArray = Array.from( document.getElementsByClassName('checkmark'))
            ...
            <div className="box">
              <div className="sort-container ">
                <label className="sort-cntr">
                  ...
                  <span className='checkmark' onClick={(e)=>radioClicked(e)}></span>
                </label>
                <label className="sort-cntr">
                  Price: low to high
                  <input type="radio" name="radio" />
